        ...
        Assertions
            .assertThat(
                Assertions.catchThrowable {
                    bearerTokenClientInterceptor.intercept(
                        req,
                        ByteArray(0),
                        execution,
                    )
                ...
                "could not find oauth2 client config for uri=http://clientResource.no and grant type=urn:ietf:params:oauth:grant-type:jwt-bearer",
            )
    }
}
